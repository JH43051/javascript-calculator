...
const zeroStyle = { borderRadius: '0px 0px 0px 5px' };
	...
	render() {
		return (
			<div>
				...
				<button id="multiply" value='x' onClick={this.props.operators} style={multiStyle}>x</button>
				...
				<button id="zero" value='0' onClick={this.props.numbers} className='jumbo' style={zeroStyle}>0</button>
